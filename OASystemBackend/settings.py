"""
Django settings for OASystemBackend project.
...
SECRET_KEY = 'django-insecure-)na3a_%8iow%8o0+-2+xlj_)bpd9@)^#58)w_y4qh--+c-h!c*'
...
MIDDLEWARE = [
    ...
    # should before CommonMiddleware
...
WSGI_APPLICATION = 'OASystemBackend.wsgi.application'
